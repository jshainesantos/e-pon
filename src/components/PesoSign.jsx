function PesoSign({ size = '0.78em' }) {
  return (
    <svg
      ...
      aria-hidden="true"
      style={{ display: 'inline-block', width: size, height: size, verticalAlign: 'middle', position: 'relative', top: '-0.06em' }}
    >
...
export function PHPAmount({ amount, className = '' }) {
